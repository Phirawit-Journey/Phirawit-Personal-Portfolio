...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <button className="p-[1px] relative inline-flex ">
        <span className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg" />
        <span className="inline-flex px-7 py-3  bg-black rounded-lg  relative group transition duration-200 text-white hover:bg-transparent text-2xl font-bold ">
          {order}
        </span>
      </button>
    </div>
